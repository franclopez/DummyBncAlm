...
.controller('ALMCtrl', function($scope, $rootScope, $state, $ionicSideMenuDelegate, $ionicPopover, $ionicPopup, $ionicModal, $cordovaSocialSharing, MenuPpal, MenuPpalIngresado, MenuDerecho, Compartir, Credencial, SolAutenticacion){
