	...
	.directive('uiMoneyMask', ['$locale', function ($locale) {
		...
		return {
			...
			link: function (scope, element, attrs, ctrl) {
                ...
                //var maskPattern = currencySym+thousandsDelimiter+' #'+'##0'+decimalsPattern;
                //var maskPattern = currencySym+'###'+thousandsDelimiter+decimalsPattern;
                //var maskPattern = currencySym+' ###'+thousandsDelimiter + decimalsPattern;
                //var maskPattern = currencySym+' ###'+thousandsDelimiter;
                //var maskPattern = currencySym+' ##0'+thousandsDelimiter+decimalsPattern;
                //var maskPattern = currencySym+' ##0'+thousandsDelimiter+decimalsPattern;
                //var maskPattern = currencySym+' ##0'+thousandsDelimiter+decimalsPattern;
                //var maskPattern = currencySym+' 0#'+thousandsDelimiter+decimalsPattern;
                //var maskPattern = currencySym+' 0#'+thousandsDelimiter+decimalsPattern;
