...
.controller('ALMCtrl', function($scope, $rootScope, $state, $ionicSideMenuDelegate, $ionicPopover, $ionicPopup, $ionicModal, $cordovaSocialSharing, ALMTxt, MenuPpal, MenuPpalIngresado, MenuDerecho, Compartir, Credencial, SolAutenticacion, Salida){
    
    $scope.menuderecho = MenuDerecho.all();
    $scope.menucompartir = Compartir.all();
    $scope.menuppal = MenuPpal.all();
    $scope.menuppalTxt = ALMTxt.all();
