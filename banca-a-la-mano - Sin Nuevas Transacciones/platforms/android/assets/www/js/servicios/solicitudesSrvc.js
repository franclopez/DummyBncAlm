...
.service('SolHeader', function($rootScope, BncALMDatos){
    ...
    var solicitudHead = {
        header: function(beanBusiness){
            ...
            headerRQ.namApp = solicitudHead.nameApp();
        ...
        headerAuth: function(beanBusiness,credenciales){
            ...
            credenciales.headerRQ.namApp = solicitudHead.nameApp();
        ...
        dateCreated: function(){
            ...
            var dateCreated = '' + ahora.getFullYear()+
                (Number(ahora.getMonth()+1) > 9 ? (Number(ahora.getMonth())+1) : '0'+ (Number(ahora.getMonth())+1)) + 
        ...
        trnUid: function(dateCreated,userID){
            ...
            //Se definen el minimo de digitos de un documento (5) mas los ultimos 7 digitos de la fecha actual
            return userID.slice(0,5)+dateCreated.slice(7,14);
        }
    };
...
.service('SolPinRetiro', function($rootScope, BncALMDatos){
    ...
    var solicitud = {
        solicitudPin: function(consulta){
            ...
            consulta.acctFrom = {
                acctID: solicitud.acctID(),
                acctTypeCode: solicitud.acctTypeCode()
            };
