	...
	$.fn.priceFormat = function(options)
	{
		...
		return this.each(function(){
			...
			function key_check (e){
                var code = (e.keyCode ? e.keyCode : e.key);
            ...
            function key_check_simulado(e){
				var typed = String.fromCharCode(e);
				var str = value;
				var newValue = price_format(str+typed);
                if(str!=newValue){
                    set(newValue);
            ...
            function volver_normalidad(){
                price_it();
                key_check(39);
                key_check_simulado(39);
                /*
                var derecha = 39;//a la derecha
                var izquierda = 37;//a la izquierda
                */
            }
            
            function prueba_press(e){
                price_it();
                key_check(e);
            }
            ...
            obj.bind('focusin.price_format', volver_normalidad);
            obj.bind('keypress.price_format', key_check);
